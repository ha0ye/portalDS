...
#'   Hastings & Powell (1991) \url{<http://dx.doi.org/10.2307/1940591>}. The 
...
#' @param ... remaining arguments to be passed to \link{\code[deSolve]{ode}}
#'
#' @return a matrix (and `deSolve`) object with the observations (and times)
#' 
#' @export
make_3sp_food_chain_block <- function(params = c(a_1 = 2.5, b_1 = 3.2, 
                                                 a_2 = 0.1, b_2 = 2.0, 
                                                 d_1 = 0.2, d_2 = 0.015), 
